...
import PeakFitness from "@/Work_description/PeakFitness";
...
export default function Main() {
  ...
  const [peakState, setPeak] = useState(false);
  ...
  function Contactform() {
    ...
    return (
      <form className="fillable" onSubmit={handleSubmit}>
        <p>
          I'm interested in work opportunities and connecting with likeminded
          individuals. If you have any questions regarding my portfolio or want
          to connect feel free to reach me below!
        </p>
        <br />
        ...
        <button
          type="submit"
          className={clicked ? "button_dark" : "button_sub"}
    ...
    <div className={clicked ? "dark-mode" : "body"}>
      <div className={"headbar" + hState}>
        ...
        <div className="navmenu">
          ...
          <a href="#contactme" className="nav">
            Contact
          </a>
      ...
      <span className={clicked ? "circle2" : "circle"}></span>
      ...
      <div className="main_content">
        ...
        <div id="landing_page">
          <div>
            <h1 className="headline">
              ...
              <span className="U">u</span>,<br />A Software Developer.
            </h1>

            <h2 className="subheading">Passionate Developer based in Canada</h2>
            <br />
            ...
            >
              <Image
                src={clicked ? "/github_white.png" : "/github.png"}
                width={40}
                height={40}
                alt="github link"
              />
            ...
            >
              <Image
                src={clicked ? "/linkedin_white.png" : "/linkedin.png"}
                width={40}
                height={40}
          ...
          <div className="logo">
            <Image
              src={clicked ? "/ER_logo_D.png" : "/ER_logo_L.png"}
              width={600}
              height={600}
              alt="Esau logo"
              priority={true}
        ...
        >
          <Image
            src={clicked ? "/light_mode.png" : "/dark_mode.png"}
            width={25}
            height={25}
        ...
        <div id="aboutme" className="container">
          <h1 className="subheadline">
            ...
            bo
            <span className="yellow">u</span>t M<span className="red">e</span>
          </h1>
        ...
        <div id="resume" className="container">
          <h1 className="subheadline">
            <span className="blue">S</span>kill<span className="yellow">s</span>{" "}
            <span className="green">a</span>nd <span className="red">E</span>xp
            <span className="blue">e</span>ri<span className="green">e</span>nc
            <span className="yellow">e</span>
          </h1>
          <h3>Where I've worked</h3>
          <div className="timeline">
            <div className="panel">
              <button className="tab-1" onClick={handlePeak}>
                Peak Fitness
              </button>
              <button className="tab-1" onClick={handleCG}>
                Cloud Genie
              </button>
              <button className="tab-1" onClick={handleNellie}>
                Nellie Health
              </button>
              <button className="tab-1" onClick={handleTMU}>
                TMU
              </button>
          ...
          <div className="orbit-container">
            ...
            <div className="inner-orbit">
              <span className="inner-orbit-circle">
                {" "}
                <Image src="/reactjs-icon.svg" width={40} height={40} />
              </span>
            </div>
            <div className="middle-orbit">
              <span className="middle-orbit-circle">
                {" "}
                <Image src="/html.svg" width={40} height={40} />
              </span>
              <span>
                {" "}
              ...
              <span>
                {" "}
                <Image src="/css3.svg" width={40} height={40} />
              </span>
            </div>
            <div className="outer-orbit">
              <span className="outer-orbit-circle">
                {" "}
                <Image src="/python.svg" width={50} height={50} />
              </span>
              <span>
                {" "}
                <Image src="/nodejs.svg" width={40} height={40} />
              </span>
              <span>
                {" "}
                <Image src="/expressjs.svg" width={40} height={40} />
              </span>
            </div>
          </div>
        ...
        <div id="contactme" className="container">
          <div className="contactme_header">
            <h1 className="subheadline">
              Cont<span className="green">a</span>ct M
        ...
        <div id="projects">
          ...
          <br />
          <p>Here are some things I've created!</p>
          <br />
                ...
                <div className="card_inner">
                  <div className="project_header">
                    ...
                    <div className="project_link">
                      <a
                        href="https://github.com/codehoover/Weather_app"
                        target="_blank"
                      >
                        <Image
                          src={"/link_light.png"}
                  ...
                  <p className="project_body">
                    {" "}
                    Created an application in HTML, CSS, and JavaScript which
                    pulls data from the openweather API to display the current
                    weather of a select city.
                  </p>
                </div>
              </div>
              ...
              <div className="project_card">
                ...
                <div className="card_inner">
                  <div className="project_header">
                    <a
                      className="project_folder"
                      href="https://astro-athletics.vercel.app/"
                      target="_blank"
                    >
                      <Image
                        src={"/web_light.png"}
                    ...
                    <div className="project_link">
                      <a
                        href="https://github.com/codehoover/ecom_page"
                        target="_blank"
                      >
                        <Image
                          src={"/link_light.png"}
                  ...
                  <p className="project_body">
                    {" "}
                    Astro Athletics is a clothing brand/ecommerce site meant to
                    display my front-end design capabilities. Built using
                    Nextjs.
                  </p>
                </div>
              </div>
